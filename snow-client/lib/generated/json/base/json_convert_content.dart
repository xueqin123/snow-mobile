...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case RspLoginEntity:
			...
			return rspCredentialEntityFromJson(data as RspCredentialEntity, json) as T;			case ReqUserEntity:
			return reqUserEntityFromJson(data as ReqUserEntity, json) as T;			case ReqLoginEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case RspLoginEntity:
			...
			return rspCredentialEntityToJson(data as RspCredentialEntity);			case ReqUserEntity:
			return reqUserEntityToJson(data as ReqUserEntity);			case ReqLoginEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'RspLoginEntity':
			...
			return RspCredentialEntity().fromJson(json);			case 'ReqUserEntity':
			return ReqUserEntity().fromJson(json);			case 'ReqLoginEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'RspLoginEntity':
			...
			return List<RspCredentialEntity>();			case 'ReqUserEntity':
			return List<ReqUserEntity>();			case 'ReqLoginEntity':
