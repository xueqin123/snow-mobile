...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case GroupEntity:
			...
			return groupDetailFromJson(data as GroupDetail, json) as T;			case HostEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case GroupEntity:
			...
			return groupDetailToJson(data as GroupDetail);			case HostEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'GroupEntity':
			...
			return GroupDetail().fromJson(json);			case 'HostEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'GroupEntity':
			...
			return List<GroupDetail>();			case 'HostEntity':
